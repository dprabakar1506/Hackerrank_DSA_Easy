...
class Result {
    ...
    int count = 0; // Initialize a counter for divisible pairs
        ...
        for (int i = 0; i < n; i++) {
            ...
            for (int j = i + 1; j < n; j++) {
                ...
                if ((ar.get(i) + ar.get(j)) % k == 0) {
                    count++; // Increment the counter if the sum is divisible
                }
            }
        }
        return count; // Return the total count of divisible pairs
